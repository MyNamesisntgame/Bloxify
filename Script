...
getgenv().apikey = "OAuth token here"
loadstring(game:HttpGet("https://raw.githubusercontent.com/MyNamesGabe/Roblox-Spotify/main/Script"))()
...
SearchBox.Position = UDim2.new(-0.093, 0, 0.126, 0)
SearchBox.Size = UDim2.new(0, 586, 0, 30)
...
TextBox.Position = UDim2.new(0.074, 0, 0, 0)
...
ScrollingFrame.Position = UDim2.new(-0.093, 0, 0.25, 0)
ScrollingFrame.Size = UDim2.new(0, 586, 0, 223)
...
Result_Artist.Position = UDim2.new(0.556, 0, 0, 0)
Result_Artist.Size = UDim2.new(0, 348, 0, 20)
...
Result_Title.Position = UDim2.new({0.556, 0},{0, 0})
Result_Title.Size = UDim2.new(0, 347, 0, 20)
...
Result_Clicked.Position = UDim2.new(0.556, 0, 0, 0)
...
Result_Clicked.Size = UDim2.new(0, 586, 0, 40)
Result_Clicked.Image = "rbxasset://textures/ui/GuiImagePlaceholder.png"
Result_Clicked.ImageTransparency = 1.000

Logo.Name = "Logo"
Logo.Parent = SearchBox
Logo.BackgroundColor3 = Color3.fromRGB(18, 18, 18)
Logo.BackgroundTransparency = 0
Logo.BorderSizePixel = 0
Logo.Position = UDim2.new(-0.118, 0, -1.3, 0)
Logo.Size = UDim2.new(0, 725, 0, 38)
Logo.Image = "http://www.roblox.com/asset/?id=9292317432"
